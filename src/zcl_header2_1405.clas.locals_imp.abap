CLASS lhc_Header DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    TYPES:
      t_entities_create TYPE TABLE FOR CREATE zr_header2_1405\\Header,
      t_entities_update TYPE TABLE FOR UPDATE zr_header2_1405\\Header,
      t_failed_Header   TYPE TABLE FOR FAILED EARLY zr_header2_1405\\Header,
      t_reported_Header TYPE TABLE FOR REPORTED EARLY zr_header2_1405\\Header.
